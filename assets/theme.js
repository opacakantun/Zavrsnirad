...
var ajaxifyShopify = (function(module, $) {
  ...
  flipSetup = function () {
    ...
    var checkoutBtn = $('<a href="' + cartUrl + '" class="flip-back" style="background-color: #C00; color: #fff;" id="flip-checkout">' + "Završi kupnju" + '</a>').addClass($btnClass),
        flipLoader = $('<span class="ajaxifyCart-loader"></span>'),
        flipExtra = $('<div class="flip-extra">' + "ili" + ' <a href="#" class="flip-cart">' + "Prikaži košaricu" + ' (<span></span>)</a></div>');
  ...
  modalSetup = function () {
    ...
    $modalContainer.prepend('<button class="ajaxifyCart--close" title="' + "Zatvori košaricu" + '">' + "Zatvori košaricu" + '</button>');
  ...
  buildCart = function (cart) {
    ...
    // Show empty cart
    if (cart.item_count === 0) {
      $cartContainer.append('<h2>' + "Vaša je košarica trenutno prazna." + '</h2><span class="cart--continue-message">' + "Nastavi pregledavanje \u003ca href=\"\"\u003eovdje\u003c\/a\u003e." + '</span><span class="cart--cookie-message">' + "Omogućite kolačiće da biste koristili košaricu" + '</span>');
    ...
    productVariantCallback: function(variant) {
      ...
      if (variant) {
        ...
        if (variant.available) {
          ...
          this.settings.selectors.$addToCartText.html("Dodaj u košaricu");
          ...
          this.settings.selectors.$addToCartText.html("Uskoro");
        ...
        if (this.settings.showComparePrice == 'true' ) {
          if (variant.compare_at_price > variant.price) {
            ...
            customPriceFormat += ' <span class="visually-hidden"><span class="visually-hidden">Redovna cijena</span> ' + a11yComparePrice + '</span>';
            customPriceFormat += ' <span class="visually-hidden"><span class="visually-hidden">Prodajna cijena</span> ' + a11yPrice + '</span>';
          }
        }
        ...
        if ( variant.compare_at_price > variant.price ) {
          ...
          this.settings.selectors.$comparePrice.html("Ušteda [$]".replace('[$]', priceSaving)).show();
        } else {
